...
public class SwipeBackLayout extends FrameLayout {
    ...
    public static interface SwipeListener {
        ...
        void onScrollPercentChange(float scrollPercent);
    }
    ...
    public void setDragging(MotionEvent ev, int dragsStarted) {
        mTrackingEdge = dragsStarted;
        mDragHelper.setDraggingState(ev, dragsStarted);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mContentView != null) {
          try {
            ...
            // Added View has RecyclerView as parent but view is not a real child. Unfiltered index:2
          }
        }
        mInLayout = false;
    }
...
//        decorChild.setBackgroundResource(Color.TRANSPARENT);
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mListeners != null && !mListeners.isEmpty()){
              for (SwipeListener listener : mListeners) {
                listener.onScrollPercentChange(mScrollPercent);
              }
            }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if ((mTrackingEdge & EDGE_LEFT) != 0) {
                ...
                top = (yvel > 0 || (yvel == 0 && (mScrollPercent > mScrollThreshold)))
                    ? (childHeight + mShadowTop.getIntrinsicHeight() + OVERSCROLL_DISTANCE)
                    : 0;
            }
